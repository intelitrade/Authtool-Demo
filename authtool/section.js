		...
		function moveAtSections(pageX, pageY)
		{
			...
			{	
				...
				if(oRefElement)
				{
					...
					if(isInputValid(sElementId) && sElementId.search("HEADER_")!=-1 && (oRefElement.typeofsection==oSectionElement.sectiontype||oRefElement.typeofsection=="NOTECONTROL"&&oSectionElement.sectiontype!="NOTECONTROL"))// && sElementId.search("row_")!=-1||sElementUse=="tablecontainer")
					{
						//debugger;
						//debugger;
