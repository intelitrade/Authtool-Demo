function updatePreviewPane(oElement)
{
	try{
        ...
        //Show table control
        var sShowTableStr = sPreviewControlDiv+'<br><input type="button" value="Update" tablename="' + sTable + '" onClick=""/> <input type="button" value="Preview" tablename="' + sTable + '" onClick="previewDocument(this.tablename)"/></div><br>';
